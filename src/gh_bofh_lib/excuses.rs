...
pub const CLASSIC: [&str; 477] = [
    ...
    "Little hamster in running wheel had coronary; waiting for replacement to be Fedexed from \
     Wyoming",
    ...
    "That's a great computer you have there; have you considered how it would work as a BSD \
     machine?",
    ...
    "Flat tire on station wagon with tapes.  ('Never underestimate the bandwidth of a station \
     wagon full of tapes hurling down the highway' Andrew S. Tannenbaum)",
    ...
    "Just pick up the phone and give modem connect sounds. 'Well you said we should get more \
     lines so we don't have voice lines.'",
    "Quantum dynamics are affecting the transistors",
    "Police are examining all internet packets in the search for a narco-net-trafficker",
    "We are currently trying a new concept of using a live mouse.  Unfortunately one has yet to \
     survive being hooked up to the computer..... please bear with us",
    ...
    "Fluorescent lights are generating negative ions. If turning them off doesn't work take them \
     out and put tin foil on the ends",
    "High nuclear activity in your area",
    "What office are you in? Oh that one.  Did you know that your building was built over the \
     universities first nuclear research site? And wow aren't you the lucky one your office is \
     right over where the core is buried!",
    ...
    "That function is not currently supported but Bill Gates assures us it will be featured in \
     the next upgrade",
    ...
    "Too many little pins on CPU confusing it bend back and forth until 10-20% are neatly \
     removed. Do _not_ leave metal bits visible!",
    ...
    "Due to Federal Budget problems we have been forced to cut back on the number of users able \
     to access the system at one time. (namely none allowed.... )",
    "Too much radiation coming from the soil",
    "Unfortunately we have run out of bits/bytes/whatever. Don't worry the next supply will be \
     coming next week",
    ...
    "High altitude condensation from USAF prototype aircraft has contaminated the primary subnet \
     mask. Turn off your computer for 9 days to avoid damaging it",
    ...
    "Internet exceeded Luser level please wait until a luser logs off before attempting to log \
     back on",
    "Your EMAIL is now being delivered by the USPS",
    "Your computer hasn't been returning all the bits it gets from the Internet",
    "You've been infected by the Telescoping Hubble virus",
    "Scheduled global CPU outage",
    "Your Pentium has a heating problem - try cooling it with ice cold water.(Do not turn off \
     your computer you do not want to cool down the Pentium Chip while he isn't working do you?)",
    "Your processor has processed too many instructions.  Turn it off immediately do not type any \
     commands!!",
    ...
    "The ATM board has run out of 10 dollar notes.  We are having a whip round to refill it care \
     to contribute ?",
    ...
    "Communist revolutionaries taking over the server room and demanding all the computers in the \
     building or they shoot the sysadmin. Poor misguided bofh_stringls",
    ...
    "Sysadmins unavailable because they are in a meeting talking about why they are unavailable \
     so much",
    ...
    "Terrorists crashed an airplane into the server room have to remove /bin/laden. (rm -rf \
     /bin/laden)",
...
pub const MODERN: [&str; 115] = [
    ...
    "Quantum encryption keys are out of sync: please wait for the next Big Bang",
    "Failure to agree on a smart contract: one of the parties is not smart enough",
    ...
    "Insufficient data for Predictive Maintenance: please wait for the next breakdown",
    "AI model experiencing existential crisis: please wait for the next iteration",
    "Excessive server load on the Serverless Architecture",
    "Inconsistent state in the Multi-Cloud environment: Consider moving to the Multi-Verse",
    "Failure in decoding genetic algorithms: please wait for the next generation",
    "Mismatched Convolutional Neural Networks: Too many revolutions in the filter",
    ...
    "Problems due to Zero Knowledge Proof: Can't prove that the system is broken",
    "Failure in Digital Twin synchronization: Quantum entanglement not achieved",
    ...
    "Insufficient entropy in the Random Number Generator: please wait for the next cosmic ray \
     burst",
    ...
    "Machine Learning model took 'unsupervised learning' too literally and ran away",
